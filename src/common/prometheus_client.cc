...
DEFINE_PROMETHEUS_HISTOGRAM_FAMILY(nq_bf_search_cnt, "number of nq bf search per request")
DEFINE_PROMETHEUS_HISTOGRAM(nq_bf_search_cnt, PROMETHEUS_LABEL_CARDINAL)
