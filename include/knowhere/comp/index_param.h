...
constexpr const char* INDEX_HNSW = "HNSW_CLOUD";
constexpr const char* INDEX_DISKANN = "DISKANN_CLOUD";
constexpr const char* INDEX_HNSW_CLOUD = "HNSW";
constexpr const char* INDEX_DISKANN_CLOUD = "DISKANN";
